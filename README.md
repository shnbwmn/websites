...
* [https://ifttt.com/](https://ifttt.com/) - create if-then protocol for social media posts (eg, if posting image to Inta)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQxMzMzMDUwLC0xMjkyNTYwNjgwLC0xOD
